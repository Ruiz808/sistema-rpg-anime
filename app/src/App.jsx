...
export default function App() {
    ...
    // 🔥 A TRAVA DE SEGURANÇA (Se não tiver mesa, não entra no RPG) 🔥
    if (!mesaId) {
        return <LobbyNeon />;
    }
    ...
    if (loading || !themeReady) {
        return (
            <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#050505' }}>
                <div style={{ padding: 20, color: '#00ffcc', fontFamily: 'monospace', fontSize: '1.2em' }}>
        ...
        return (
            <div className="modal-overlay" style={{ display: 'flex' }}>
                <form className="modal-box" onSubmit={handleNameSubmit}>
                    ...
                    <p style={{ color: '#fff' }}>Digite o nome do seu personagem para entrar na sala {mesaId}:</p>
