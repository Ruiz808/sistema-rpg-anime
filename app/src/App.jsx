...
// ============================================================================
// 🛠️ FUNÇÕES AUXILIARES (LÓGICA DO SEU APP ORIGINAL)
// ============================================================================
...
// ============================================================================
// 🔥 PAINEL DO MESTRE AVANÇADO (O que eu tinha apagado!) 🔥
// ============================================================================
function MestrePanel() {
    ...
    const handleClonarFicha = (nomeOriginal, fichaOriginal) => {
        ...
        if (window.confirm(`Deseja criar a entidade duplicada "${nomeSanitizado}" e assumir o controle dela agora?`)) {
            ...
            setTimeout(() => {
                alert(`✨ O CLONE FOI CRIADO E CARREGADO: ${nomeSanitizado} ✨\n\n⚠️ IMPORTANTE: Vá até a "Ficha Narrativa" ou "Editor" e clique em "SALVAR" para que o clone seja guardado no Firebase!`);
            }, 600);
        }
    };
                            ...
                            return (
                                <div key={nome} style={{ 
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px', marginTop: '5px', position: 'relative', zIndex: 2 }}>
                                        ...
                                        <span style={{ color: subColor, fontSize: (isGrand || isCandidato) ? '0.85em' : '0.8em', fontStyle: 'italic', fontWeight: (isGrand || isCandidato) ? 'bold' : 'normal', textShadow: isGrand ? '0 0 5px #ff003c' : (isCandidato ? '0 0 5px #0088ff' : 'none')}}>
                                            {subText}
                                        </span>
                                    </div>
