...
export default function MapaMundi({ children }) {
    ...
    // 🎥 CÂMERA 3D DO SISTEMA SOLAR (Escala Ouro)
    ...
    // 🎛️ PAINEL DE ENGENHARIA SOLAR (Ajustado para Escala 1000x500)
                ...
                {['terra0', 'vegeta', 'namekusei', 'desconhecido'].map(id => (
                    <div key={id} style={{ marginBottom: '5px', paddingBottom: '10px', borderBottom: '1px dotted #333' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px' }}>
                            ...
                            <input type="range" min="50" max="1500" step="10" value={configOrbitas[id].rx} onChange={(e) => setConfigOrbitas(prev => ({...prev, [id]: {...prev[id], rx: parseInt(e.target.value)}}))} />
                    ...
                    return (
                        <div key={id} style={{ marginBottom: '5px', paddingBottom: '10px', borderBottom: '1px dotted #333' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px' }}>
                                ...
                                <input type="range" min="0" max="2000" step="10" value={parseInt(star.left)} onChange={(e) => {
                                ...
                                <input type="range" min="0" max="1000" step="10" value={parseInt(star.top)} onChange={(e) => {
    ...
    // ==========================================
    // 🌌 TELA 0: SISTEMA SOLAR CÂMERA 3D (DIORAMA PERFEITO)
    // ==========================================
