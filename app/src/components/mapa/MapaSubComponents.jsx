...
import { salvarDummie, salvarCenarioCompleto, enviarParaFeed, salvarFichaSilencioso } from '../../services/firebase-sync'; 
    ...
    useEffect(() => {
        ...
        if (playPromise !== undefined) {
            playPromise.then(() => {
                ...
                console.warn(`[VOZ-PLAYER] Navegador bloqueou o autoplay para ${nome}. Por favor, clique na ecrã!`, e);
                const forcePlay = () => {
                    audioEl.play().catch(()=>{});
