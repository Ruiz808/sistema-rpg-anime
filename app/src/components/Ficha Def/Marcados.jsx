...
const LabelMagico = ({ valor, onChange, fallback }) => (
    <input 
        ...
        onBlur={(e) => { e.target.style.borderBottom = '1px solid transparent'; if (typeof salvarFirebaseImediato === 'function') salvarFirebaseImediato(); else salvarFichaSilencioso(); }}
